...
cumplimientooserv.actualizafinaltransporte = async (final) => {
    //console.log("DATA : ", final);
    const urlUpdate = baseUrl + "/actualizafinaltransporte/" + final.id_actividad
    const res = await axios.put(urlUpdate, final)
        .then(response => { return response.data; })
        .catch(error => { return error; })
...
cumplimientooserv.actualizainiciatransporte = async (inicia) => {
    //console.log("DATA : ", inicia);
    const urlUpdate = baseUrl + "/actualizainiciatransporte/"+inicia.id_actividad
    const res = await axios.put(urlUpdate, inicia)
        .then(response => { return response.data; })
        .catch(error => { return error; })
