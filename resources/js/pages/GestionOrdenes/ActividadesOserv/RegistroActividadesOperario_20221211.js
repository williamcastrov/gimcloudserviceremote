...
*/
  ...
  const [serialEquipo, setSerialEquipo] = useState(0);
  ...
  const crearPendiente = () => {
    {
      setPendienteSeleccionado([{
        ...
        seriecomponente: serialEquipo,
        voltajecomponente: marcaEquipo,
        estado_pot: 84,
        novedad_pot: "",
      ...
      <Form {...layout} >
        ...
        <Row justify="center"  >
          ...
          <Item
            ...
            >
              <Input
                name='seriecomponente'
                style={{ width: 190 }}
                onChange={(e) => setSerialEquipo(e.target.value)}
                value={cumplimientoSeleccionado && cumplimientoSeleccionado.seriecomponente}
              ></Input>
            </Item>
          </Col>
          <Col lg={6}>
          <Item
            ...
            >
              <Input
                ...
                value={cumplimientoSeleccionado && cumplimientoSeleccionado.nombrecomponente}
              ></Input>
            </Item>
          </Col>
        </Row>
