...
class CumplimientoOServController extends Controller
{
    ...
    public function create(Request $request){
        try { 
          ...
          $insert['nombrecomponente']          = $request['nombrecomponente'];
          ...
          $insert['observacioninterna']         = $request['observacioninterna'];
      ...
      public function actualizafinaltransporte(Request $rec){
        try {
          //$data['finaltransporte_cosv'] = NOW();
          $res = DB::update("update cumplimientooserv set finaltransporte_cosv = '".$rec->fecha."',
                                                          fechainicia_cosv     = '".$rec->fecha."'
                             where id_actividad = ". $rec->id_actividad);
      ...
      public function actualizainiciatransporte(Request $rec){
        try {
          //return $datos;
          //exit;
          //$data['iniciatransporte_cosv'] = NOW();
          $res = DB::update("update cumplimientooserv set iniciatransporte_cosv =  '".$rec->fecha."' where id_actividad = ".$rec->id_actividad);
      ...
      public function update(Request $request, $id_actividad){
        try {
          ...
          $data['nombrecomponente']          = $request['nombrecomponente'];
          ...
          $data['observacioninterna']         = $request['observacioninterna'];
